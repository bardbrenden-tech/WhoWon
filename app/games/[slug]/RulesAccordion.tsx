...
export default function RulesAccordion({ rules }: { rules: GameRules }) {
  const [showFull, setShowFull] = useState(false)

  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-5">
      <h2 className="font-bold text-gray-900 mb-4">📋 Rules</h2>
      ...
      >
        {showFull ? 'Hide full rules ▲' : 'Show full rules ▼'}
      </button>

      {showFull && (
        <div className="mt-4 pt-4 border-t border-gray-100">
          <h3 className="text-sm font-semibold text-gray-700 mb-2">Full rules</h3>
          <ul className="space-y-1.5">
