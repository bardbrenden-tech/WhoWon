...
export async function GET() {
  ...
  const games = [
    ...
    },
    {
      id: 'shuffleboard',
      name: 'Shuffleboard',
      name_alt: 'Bordshuffleboard',
      category: 'sport',
      description: 'Skyv pucker nedover bordet inn i poengsonene 1-2-3. Poeng kanselleres mot hverandre — første til 15 eller 21 vinner. Fungerer for både single og double.',
      min_players: 2,
      max_players: 4,
      higher_is_better: true,
      active: true,
